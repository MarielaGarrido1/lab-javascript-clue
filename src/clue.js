...
const suspectsArray = [
...

  {
    ...
    occupation: 'Scientis',
    age: 26,
    description: 'PhD in plant tocicology. Adopted daughter of Mr Boddy',
...
function selectRandom(Array) {
  const resultadoAleatorio =Math.floor(Math.random()*Array.length)
  return Array[resultadoAleatorio]
}
